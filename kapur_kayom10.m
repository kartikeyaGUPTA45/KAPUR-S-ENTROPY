...
function [out]=kapur_kayom10(th,p,ch)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    w9=double(ch(t10)-ch(t9));      % class probability, w9
    w10=1-(w0+w1+w2+w3+w4+w5+w6+w7+w8+w9);   
    ...
    out=H0+H1+H2+H3+H4+H5+H6+H7+H8+H9+H10;
end
